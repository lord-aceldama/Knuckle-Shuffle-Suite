...
* __abacus.py:__ Will eventually be incorporated into knuckle-shuffle.py. It's basically just here as 
  a development script so i can experiment without altering the future host. 
