...
Adapted from:
https://gist.github.com/christian-oudard/220521
...
if __name__ == '__main__':
    ...
    print_color('  ', fg=rgb(0, 0, 0), end='')
    print('  '*7, end='')
    print_color('   X', fg=rgb(1, 1, 1), end='')
    print('  '*2, end='')
    print_color('   X', fg=rgb(2, 2, 2), end='')
    print('  '*2, end='')
    print_color('   X', fg=rgb(3, 3, 3), end='')
    print('  '*2, end='')
    print_color('   X', fg=rgb(4, 4, 4), end='')
    print('  ', end='')
    print_color(' X', fg=rgb(5, 5, 5), end='')
    print()
